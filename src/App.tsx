            ...
            <div className="max-w-7xl mx-auto space-y-6 flex-grow w-full p-4 md:p-8" id="table-controls">
                ...
                <footer className="mt-8 px-3 py-8 border-t border-slate-200 text-center">
                    <div className="max-w-3xl mx-auto space-y-4">
                        ...
                        <p className="text-slate-500 text-sm">
                            <span className="font-semibold text-slate-700 block mb-1">ข้อควรระวัง และข้อจำกัดของข้อมูล</span>
                            ...
                            ปีที่ดำรงตำแหน่ง: ข้อมูลปีที่ดำรงตำแหน่งอาจไม่ถูกต้อง 100% เนื่องจากแหล่งข้อมูลที่ใช้ในการประมวลผลเป็นลักษณะของรายงานประจำปี และชุดของกรรมการ ซึ่งอาจจะส่งผลให้มีความคาดเคลื่อนได้<br />
                            {activeTab === 'minister' ? (
